...
public class HtmlFromPages {
    ...
    public static final String HTML_ADMIN_NEW_PLANE_GESTIONS = "adminPages/AdminNewPlaneGestions";
    public static final String HTML_ADMIN_PLANE_GESTIONS = "adminPages/AdminPlaneGestions";
